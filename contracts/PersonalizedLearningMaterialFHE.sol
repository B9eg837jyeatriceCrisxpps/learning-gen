...
contract PersonalizedLearningMaterialFHE is SepoliaConfig {
    // Encrypted report structure to store the encrypted data
    ...
    // Decrypted report structure (for after decryption)
    ...
    // Modifier to ensure only the reporter can request decryption
    modifier onlyReporter(uint256 reportId) {
        // In a real implementation, add access control logic
